...
<html>
    ...
    <body style="background-color: black;
        ...
        <div class="jumbotron" style="text-align: center;">
            <h1>ชิ้นส่วนอะไหล่จักรยานเสือภูเขา</h1>      
        ...
        <div class="col-sm-9">
            <div class="row" id="section1" style="height: 350px;">    
                    ...
                    <div class="img-thumbnail" title="เฟรม mosso 7580CB 15.5">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part1.jpg" alt="เฟรม mosso 7580CB 15.5" >
                        </a>
                    </div>
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม Giant XTC SLR 2015">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part2.jpg" alt="เฟรม Giant XTC SLR 2015" >
                        </a>
                    </div>
                    <div class="productDetail">
            ...
            <div id="section2" style="height: 350px;"> 
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม mosso 7580CB 15.5">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part1.1.jpg" alt="เฟรม mosso 7580CB 15.5" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม mosso 7580CB 15.5">
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม Giant XTC SLR 2015">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part2.1.jpg" alt="เฟรม Giant XTC SLR 2015" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม Giant XTC SLR 2015">
            ...
            <div id="section3" style="height: 350px;">         
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม mosso 7580CB 15.5">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part1.2.jpg" alt="เฟรม mosso 7580CB 15.5" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม mosso 7580CB 15.5">
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม Giant XTC SLR 2015">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part2.2.jpg" alt="เฟรม Giant XTC SLR 2015" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม Giant XTC SLR 2015">
            ...
            <div id="section4" style="height: 350px;">         
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม mosso 7580CB 15.5">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part1.3.jpg" alt="เฟรม mosso 7580CB 15.5" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม mosso 7580CB 15.5">
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม Giant XTC SLR 2015">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part2.3.jpg" alt="เฟรม Giant XTC SLR 2015" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม Giant XTC SLR 2015">
            ...
            <div id="section5" style="height: 350px;">         
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม mosso 7580CB 15.5">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part1.4.jpg" alt="เฟรม mosso 7580CB 15.5" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม mosso 7580CB 15.5">
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม Giant XTC SLR 2015">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part2.4.jpg" alt="เฟรม Giant XTC SLR 2015" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม Giant XTC SLR 2015">
            ...
            <div id="section6" style="height: 350px;">         
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม mosso 7580CB 15.5">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part1.5.jpg" alt="เฟรม mosso 7580CB 15.5" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม mosso 7580CB 15.5">
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม Giant XTC SLR 2015">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part2.5.jpg" alt="เฟรม Giant XTC SLR 2015" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม Giant XTC SLR 2015">
            ...
            <div id="section7" style="height: 350px;">         
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม mosso 7580CB 15.5">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part1.6.jpg" alt="เฟรม mosso 7580CB 15.5" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม mosso 7580CB 15.5">
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม Giant XTC SLR 2015">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part2.6.jpg" alt="เฟรม Giant XTC SLR 2015" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม Giant XTC SLR 2015">
            ...
            <div id="section8" style="height: 350px;">         
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม mosso 7580CB 15.5">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part1.7.jpg" alt="เฟรม mosso 7580CB 15.5" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม mosso 7580CB 15.5">
                ...
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="img-thumbnail" title="เฟรม Giant XTC SLR 2015">
                        <a href="#">
                            <img class="productImage" style="width: 150px;height: 150px;"
                                 src="../price/mountain_bike/part2.7.jpg" alt="เฟรม Giant XTC SLR 2015" >
                        </a>
                    </div>
                    <div class="productDetail">
                        <div class="product_name" title="เฟรม Giant XTC SLR 2015">
            ...
            <div id="section9" style="height: 100px;">
                <button class="btn btn-info" style="width: 100%;margin-top: 15px;"><h4>ยืนยันการเลือกสินค้า</h4></button>
            </div>
