...
<html>
    ...
    <body style="background-color: black;
        ...
        <div class="row">
<!--            <div class="col-sm-2" style="background-color: rgba(1,1,1,0.65);height: 2650px;">
                <div class="container" style="width: 100%;border: 0.2;border-color: #414141;">

                    <a href="#" class="btn btn-info" style="width: 100%;"><h1>ประเภทจักรยาน</h1></a><br>

                    <div id="bike" style="background-color: rgba(1,1,1,0.65);color: white;text-align: center;">
                        <a href="mountain_bike.jsp"><b><h2><button class="btn btn-info">จักรยานเสือภูเขา</button></h2></b></a>
                        <a href="road_bike.jsp"><b><h2><button  class="btn btn-info" >จักรยานเสือหมอบ</button></h2></b></a>
                    </div>
                </div>
            </div>-->
            ...
            <div class="row">
                <div class="col-lg-8" style="background-color: rgba(1,1,1,0.65);text-align: center;
                    ...
                    <div class="jumbotron">
                        <h1>เลือกประเภทจักรยาน</h1>      
                        <p>ประเภทจักรยานของทางร้านค้า</p>
                    </div>
                    <div id="bike" style="background-color: rgba(1,1,1,0.65);color: white;text-align: center;">
                        <a href="mountain_bike.jsp"><b><h2>
                                    <button class="btn btn-info" style="width: 100%;"><h2>จักรยานเสือภูเขา</h2></button></h2></b></a>
                        <a href="road_bike.jsp"><b><h2>
                                    <button  class="btn btn-info" style="width: 100%;"><h2>จักรยานเสือหมอบ</h2></button></h2></b></a>
                    </div>
