    ...
    <body style="background-color: black;
        ...
        <div class="row">
            ...
            <ul class="nav nav-tabs" style="background-color: black;">
                <li><a href="index_manager.jsp"><h3>หน้าหลัก</h3></a></li>
                <li><a href="Count_Ordering.jsp"><h3>ยอดการสั่งซื้อ</h3></a></li>
                <li><a href="Financial.jsp"><h3>ข้อมูลการเงิน</h3></a></li>
                <li><a href="information_Cus.jsp"><h3>ข้อมูลลูกค้า</h3></a></li>
                <li><a href="Comment.jsp"><h3>ความคิดเห็น</h3></a></li>
